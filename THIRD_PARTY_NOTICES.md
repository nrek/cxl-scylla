...
Scylla is licensed under the MIT License. The following bundled components retain their own license.

## Scintilla and Lexilla

Scylla Workbench includes source from:
...
The original license files remain at:

- `scyllagpt/third_party/scintilla/License.txt`
- `scyllagpt/third_party/lexilla/License.txt`

## External provider software
