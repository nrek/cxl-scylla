...
"@
function ClickAbs($x,$y) { [W]::SetCursorPos($x,$y)|Out-Null; Start-Sleep -Milliseconds 300; [W]::mouse_event(0x0002,0,0,0,[IntPtr]::Zero); [W]::mouse_event(0x0004,0,0,0,[IntPtr]::Zero); Start-Sleep -Milliseconds 700 }
$p = Get-Process scylla
$h = $p.MainWindowHandle
[W]::ShowWindow($h,6)|Out-Null; Start-Sleep -Milliseconds 500
[W]::ShowWindow($h,9)|Out-Null; [W]::SetForegroundWindow($h)|Out-Null; Start-Sleep -Milliseconds 1300
